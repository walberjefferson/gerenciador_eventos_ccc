 ...
 *
 * Espelha as restricoes do banco: o grupo pertence a uma cidade e o nome nao
 * se repete dentro dela.
 */
class GrupoParticipanteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'nome' => [
                ...
                // O nome do grupo nao se repete dentro da mesma cidade.
    ...
    {
        return [
            'cidade_id.required' => 'Escolha a cidade do grupo.',
            'cidade_id.exists' => 'Essa cidade não está no catálogo.',
            'nome.required' => 'Informe o nome do grupo.',
            'nome.max' => 'O nome do grupo pode ter no máximo 120 caracteres.',
            'nome.unique' => 'Já existe um grupo com esse nome nesta cidade.',
        ];
    }
