 ...
 * na tela. A diferenca importa: quem digita e ainda nao clicou em "Filtrar" nao
 * mudou a lista, e o cabecalho estaria mentindo se ja contasse.
 */
...
<template>
    <PainelDeFiltros id="filtros" :ativos="filtrosAtivos">
        <form aria-labelledby="titulo-filtros" class="grid gap-4" @submit.prevent="aplicar">
            <div class="grid gap-4 md:grid-cols-3">
                <div class="flex flex-col gap-1">
                    ...
                    />
                    <p id="ajuda-filtro-busca" class="text-muted-foreground text-sm">Nome, e-mail ou código da inscrição. O CPF não é buscável.</p>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select
                        ...
                        class="border-input bg-background focus-visible:ring-ring h-10 w-full rounded-md border px-3 text-sm focus-visible:ring-2 focus-visible:outline-hidden disabled:opacity-60"
                    >
                        <option :value="null">Todas</option>
                    ...
                    <p id="ajuda-filtro-atividade" class="text-muted-foreground text-sm">Escolha um evento primeiro para filtrar por atividade.</p>
                </div>
